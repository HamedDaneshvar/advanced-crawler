...
class FakeDb {
  getAssetLocalPath(url: string): string | undefined {
    if (url === "https://cdn.example.com/app.js") return "assets/cdn.example.com/app.js";
    return undefined;
  }
}
...
describe("rewriteHtml", () => {
  it("rewrites known asset URLs", () => {
    const engine = new RewriteEngine(new FakeDb() as never);
